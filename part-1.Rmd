...
type = "f" innebär att variabler läses in som faktorer då kodtabell finns tillgänglig.
...
där a anger objektet för kopplingen till databasen, och därefter följer variabelnamn (case-sensitive) och val av dimension (2010). Om variabeln saknar dimensioner så hade anropet varit `a["KON"]`, eller med flera dimensioner `a["KON", c(2010, 12)]`.
